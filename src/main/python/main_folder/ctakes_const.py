...
MED_STATUS_CHANGE_INCREASE = (
    ATTR_MEDICATION_STATUSCHANGE_INCREASE  # // TO BE DEPRECATED
)
MED_STATUS_CHANGE_DECREASE = (
    ATTR_MEDICATION_STATUSCHANGE_DECREASE  # // TO BE DEPRECATED
)
MED_STATUS_CHANGE_NOCHANGE = (
    ATTR_MEDICATION_STATUSCHANGE_NOCHANGE  # // TO BE DEPRECATED
)
