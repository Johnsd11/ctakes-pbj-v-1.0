...
import sys
from process_wrapper.example_word_finder import *
...
def main():
    ...
    word_finder = ExampleWordFinder(type_system_accessor.getTypeSystem())
    pbj_receiver.start(queue_receive_cas, word_finder, type_system_accessor.getTypeSystem(), pbj_sender)
